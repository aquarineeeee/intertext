...
def test_user_and_book_children_have_database_cascade() -> None:
    ...
    for table_name in ("sessions", "books", "import_files", "chapters", "document_chunks", "reading_progress", "annotations", "excerpts", "notes", "conversations", "messages", "ai_providers", "ai_runs", "mcp_servers", "mcp_call_logs"):
